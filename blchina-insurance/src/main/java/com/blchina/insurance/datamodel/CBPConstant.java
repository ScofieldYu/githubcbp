 ...
 * 使用者必须经过许可   
 */
package com.blchina.insurance.datamodel;
...
public class CBPConstant {
   ...
   public final static String MESSAGE_TOKEN_INVALID = "您的账号已在其他设备登录";
    ...
    public final static String ORDER_NO_INSURANCE = "该订单还没有办理保险";
	...
	public static enum InsuranceTypeEnum {
		//添加枚举的指定常量
		THREEINSURANCE("1"),CARUSERINSURANCE("2"),SCRATCHINSURANCE("3"),OTHERINSURANCE("4"),BUSINESSINSURANCE("5");   // 1--私户，2--公户
