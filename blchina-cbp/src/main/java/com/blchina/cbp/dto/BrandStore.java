...
public class BrandStore {
	...
	private PaperCostsDTO paperCostsDTO;

	public PaperCostsDTO getPaperCostsDTO() {
      return paperCostsDTO;
   }

   public void setPaperCostsDTO(PaperCostsDTO paperCostsDTO) {
      this.paperCostsDTO = paperCostsDTO;
   }
