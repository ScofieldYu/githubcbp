 ...
 * 使用者必须经过许可
 */
package  com.blchina.cbp.intercept;
...
private RedisUtil redisUtil;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        try {
            ...
            if(url.contains("getToken")||url.contains("sap")||url.contains("time")||url.contains("user")||url.contains("pushCarStart")
                    ||url.contains("getReceipt")||url.contains("insertOrUpdateDeposit")||url.contains("fddCallbackManual")||url.contains("wechatPayNotify")
                    ||url.contains("setOpenId")||url.contains("getEmployeeidByCode")){
                return super.preHandle(request, response, handler);
            }
