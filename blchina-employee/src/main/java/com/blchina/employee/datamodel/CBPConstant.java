 ...
 * 使用者必须经过许可   
 */
package com.blchina.employee.datamodel;
...
public class CBPConstant {
   ...
   public final static String MESSAGE_TOKEN_INVALID = "您的账号已在其他设备登录";
    ...
    public static enum EmployeeTypeEnum {
       ...
       // 1--销售总监，						2--销售经理
       EMPLOYEE_SALES_CONSULTANT(10000066),EMPLOYEE_INSURANCE_CONSULTANT(10000060),
       //3--销售顾问                                                  4--金融承保顾问
       EMPLOYEE_BOUTIQUE_CONSULTANT(10000122),EMPLOYEE_CHECKCARPERSON_CONSULTANT(10001018),
        //5--精品顾问                                                  6--验车上牌专员
       EMPLOYEE_FINANCE_CONSULTANT(10000060),EMPLOYEE_STOREMANAGER_CONSULTANT(10000130), EMPLOYEE_SECENDCAR_CONSULTANT(10000046),
    	//7--金融承保顾问                             			 8--店总                                 9二手车评估师
    	EMPLOYEE_SECONDCAR_CHECK_CONSULTANT(10000044);
    	//10二手车验车专员
