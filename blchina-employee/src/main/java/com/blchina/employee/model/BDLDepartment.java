...
public class BDLDepartment {
    ...
    private Integer departleaderdutyid;
    ...
    public Integer getDepartleaderdutyid() {
        return departleaderdutyid;
    }

    public void setDepartleaderdutyid(Integer departleaderdutyid) {
        this.departleaderdutyid = departleaderdutyid;
    }
