...
public class BDLBrandStore<BrandStore> {
	...
	private List<BrandStore> brandStore;

	public Integer getTitleId() {
		return titleId;
	}

	public List<BrandStore> getBrandStore() {
		return JSONArray.fromObject( brandStore );
	}

	public void setBrandStore(List<BrandStore> brandStore) {
		this.brandStore = JSONArray.fromObject( brandStore );
	}
