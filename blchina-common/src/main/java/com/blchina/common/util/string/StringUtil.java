package com.blchina.common.util.string;


import com.blchina.common.pattern.PatternUtil;
...
//    }
    ...
    public static String string2Date(String data){
       String string1 = data.substring(0, 4);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(string2Date("11111111"));
