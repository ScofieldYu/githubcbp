package com.blchina.common.util.constant;
...
public class Constant {
    ...
    public final static String COOKIE_WEIXIN_USER = "cookie_speedex_user";
    public final static String COOKIE_WEIXIN_TOKEN = "cookie_speedex_user_token";
    ...
    public final static String COOKIE_USER_TOKEN = "pcusertoken";
    public final static String COOKIE_USERNAME_AND_PASSWORD = "pcusernamepassword";
