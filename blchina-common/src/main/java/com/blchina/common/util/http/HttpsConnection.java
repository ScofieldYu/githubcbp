...
public class HttpsConnection {  
    ...
    private static final  String ctype="text/html;charset=utf-8";
      
    public static String doPost(String url, String params,boolean getLocation) throws Exception {
        byte[] content = {};
        if(params != null){  
            content = params.getBytes("utf-8");
        }  
        return doPost(url, content,getLocation);
    }  
    public static String doPost(String url, byte[] content,boolean getLocation) throws Exception {
